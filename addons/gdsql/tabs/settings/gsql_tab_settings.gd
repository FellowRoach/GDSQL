...
@onready var option_button_new_tab_type: OptionButton = %OptionButtonNewTabType
...
var _default_values = {
	...
	"game_conf_db_name": "",
	"new_tab_type": 1, # 0: NEW_QUERY_TAB; 1: NEW_GRAPH_TAB; 2: NEW_MAPPER_TAB
...
func _load_settings() -> void:
	...
	# New tab type
	option_button_new_tab_type.select(settings.get_value("config", "new_tab_type", _default_values["new_tab_type"]))
...
func _on_button_save_pressed() -> void:
	...
	var new_tab_type = option_button_new_tab_type.get_selected_id()
	...
	settings.set_value("config", "new_tab_type", new_tab_type)
